...
const SHADOW_MODES = [
    ...
    { id: 'floating', nameKey: 'shadow_floating', name: 'Nổi Bay', template: '0px {b}px {b}px -{s}px {c}' },
    ...
    { id: 'double', nameKey: 'shadow_double', name: 'Viền Kép', template: '{x}px {y}px {b}px {s}px {c}, inset -{x}px -{y}px {b}px 0px rgba(255,255,255,0.15)' },
    { id: 'neumorph', nameKey: 'shadow_neumorph', name: 'Neumorphism Nổi', template: '-{x}px -{y}px {b}px rgba(255,255,255,0.4), {x}px {y}px {b}px {c}' },
    { id: 'neuro-in', nameKey: 'shadow_neuro_in', name: 'Neumorphism Chìm', template: 'inset -{x}px -{y}px {b}px rgba(255,255,255,0.4), inset {x}px {y}px {b}px {c}' },
    ...
    { id: 'clay', nameKey: 'shadow_clay', name: 'Đất Sét 3D', template: 'inset 0px -{y}px {b}px rgba(255,255,255,0.3), inset 0px {y}px {b}px rgba(0,0,0,0.2), 0px {y}px {b}px {c}' }
];
    ...
    try {
        ...
        function updateShadow() {
            ...
            activeShadows.forEach(checkbox => {
                ...
                const rgbaColor = hexToRgba(drawer.querySelector('.s-c').value, drawer.querySelector('.s-o').value);
